/**
 * Initializing the sections functionallity
 */
$( document ).ready( function() {
	...
	$( ".section" ).on( "click", function( e ) {
		...
		let section = target.closest( ".section" );
		if ( target.is( ".button.open-section" ) ) {
			section.addClass( classOpen );
			section.removeClass( classClose );
		} else if ( target.is( ".button.close-section" ) ) {
			section.addClass( classClose );
			section.removeClass( classOpen );
		}
...
$( document ).ready( function() {
	...
	$( "#send-email" ).appendTo( "#contact-info .main article" );
...
$( document ).ready( function() {
	let scrollToTopElements = $( "header .scroll-to-top, footer .logo a" );
	
	/**
	 * Initializing scroll-to-top button smooth scrolling functionallity
	 */
	UIkit.scroll( scrollToTopElements );
	 ...
	 */
	scrollToTopToggle( $( "header .scroll-to-top" ) );
